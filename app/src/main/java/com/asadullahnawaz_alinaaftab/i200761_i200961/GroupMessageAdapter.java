...
public class GroupMessageAdapter extends RecyclerView.Adapter<GroupMessageAdapter.ViewHolder> {
    ...
    public GroupMessageAdapter(ArrayList<GroupMessageModel> messages, Context context, LinkMenuInterface lcallback) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.senderName.setText(messages.get(position).senderName);
